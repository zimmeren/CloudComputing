...
public class AirportAirlineDelays {
	public static class AirportAirlineMapper extends Mapper<LongWritable, Text, TextPair, FloatPair> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			...
			if (entry.valid) {
				airportAirline.set(new Text(entry.origin), new Text(entry.carrier));
	...
	public static class AirportAirlineCombiner extends Reducer<TextPair, FloatPair, TextPair, FloatPair> {
	...
	public static class AirportAirlineReducer extends Reducer<TextPair, FloatPair, TextPair, FloatWritable> {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    Job job = Job.getInstance(conf, "AirportAirlineDelays");
	    job.setJarByClass(AirportAirlineDelays.class);
	    job.setMapperClass(AirportAirlineMapper.class);
	    job.setMapOutputValueClass(FloatPair.class);
	    job.setCombinerClass(AirportAirlineCombiner.class);
	    job.setReducerClass(AirportAirlineReducer.class);
